...
import { CreateRequest } from "../../../network/authentication/Create";
                        ...
                        <View style={{ width: "100%", height: "30%", justifyContent: "center", alignItems: "center" }}>
                            <TouchableOpacity 
                                ...
                                onPress={() => {
                                    ...
                                    CreateRequest.createAndSend(this.state.usernameText, this.state.passwordText).then((createResponse) => {
                                        if (createResponse.isSuccess()) {
                                            Cache.setCachedValue(Cache.CACHE_LOGIN_TOKEN, createResponse.getLoginToken()).then(() => {
                                                this.props.navigation.navigate(Nodes.Pets.SELECT_PET)
                                            });
                                        } else {
                                            this.state.usernameInputRef.showError(createResponse.getErrorText());
                                        }
